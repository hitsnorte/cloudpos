  ...
  >
    ...
    <thead>
            <tr>
              ...
              <th className="uppercase border-collapse border border-[#EDEBEB] w-50 sm:px-3 py-3 bg-[#FC9D25] text-[#FAFAFA] text-sm">
               <div className="flex items-left justify-left "> 
                Date Start
              </div>
              </th>
              ...
              <th className="uppercase border-collapse border border-[#EDEBEB]  w-60 sm:px-3 py-2 bg-[#FC9D25] text-[#FAFAFA] text-sm">
               <div className="flex items-left justify-left"> 
                Exploration center
              </div>
              </th>
          ...
          {sortedHour.map((hour)  => (
            <tr key={hour.Vcodi} className="hover:bg-gray-200">
              ...
              {/* Dados do Produto */}
              <td className="border border-[#EDEBEB] px-4 py-2 text-right">{hour.Vcodi}</td>
              <td className="border border-[#EDEBEB] px-4 py-2 text-left">{hour.Vdesc}</td>
             
              <td className="border border-[#EDEBEB] px-4 py-2 text-right">{hour.VHoraIni}</td>
              <td className="border border-[#EDEBEB] px-4 py-2 text-right">{hour.VHoraFim}</td>
