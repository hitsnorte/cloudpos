// src/app/api/cloudproducts/subfamilia/lista/route.js
...
export async function GET(request) {
    try {
        ...
        if (!propertyID) {
            return new Response(
                JSON.stringify({ error: "Cabeçalho 'X-Property-ID' é obrigatório." }),
        ...
        return new Response(
            JSON.stringify({ status: "success", data: subfamilias }),
