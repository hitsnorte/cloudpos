        ...
        >
          <nav className="h-full flex flex-col relative w-full">
            ...
            <div className="p-4 pb-2 flex items-center">
              ...
              <p
                className={`font-bold transition-all ml-3 ${expanded || isMobile ? "opacity-100 w-auto" : "opacity-0 w-0 overflow-hidden"
                  }`}
              >
                CloudPos
              </p>
            ...
            <div className="border-t border-gray-200 shadow-sm flex p-3 w-full relative">
              ...
              <div
                className={`flex justify-between items-center overflow-hidden transition-all duration-300 ${expanded || isMobile ? "w-full ml-3" : "w-0"
                  }`}
              >
