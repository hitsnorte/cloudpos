    ...
    <thead>
            <tr>
              ...
              <th className="uppercase border-collapse border border-[#EDEBEB] w-10 px-1 sm:px-5 py-4 bg-[#FC9D25] text-[#FAFAFA] text-sm">
                <div className="flex items-left justify-left">CodHour</div>
              </th>
              )}
               {columnVisibility.description && (
              <th onClick={() => handleSort('Vdesc')} className="uppercase border-collapse border border-[#EDEBEB] w-140 sm:px-4 py-4 bg-[#FC9D25] text-[#FAFAFA] text-sm">
             ...
             {columnVisibility.startDate && (
              <th className="uppercase border-collapse border border-[#EDEBEB] w-20 sm:px-4 py-4 bg-[#FC9D25] text-[#FAFAFA] text-sm">
