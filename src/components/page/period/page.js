  ...
  >
    ...
    <thead>
            <tr>
              ...
              <th className="uppercase border-collapse border border-[#EDEBEB] w-5 px-1 sm:px-5 py-4 bg-[#FC9D25] text-[#FAFAFA] text-sm">
                <div className="flex items-left justify-left">CodPeriod</div>
              </th>
              )}
