...
//   };
  ...
  const paginatedUnit = units.slice(
              ...
              <td className="border border-[#EDEBEB] px-1 py-1 text-center">
                <Dropdown>
                  ...
                  <DropdownMenu aria-label="Dynamic Actions" placement="bottom-end" className="bg-white shadow-lg rounded-md p-1">
                    <DropdownItem key="edit" onPress={() => alert(`Editando ${unit.Descricao}`)}>Editar</DropdownItem>
                  </DropdownMenu>
                </Dropdown>
              </td>
              
              {/* Dados do Produto */}
              <td className="border border-[#EDEBEB] px-4 py-2 text-right">{unit.Id_interno}</td>
              <td className="border border-[#EDEBEB] px-4 py-2 text-left">{unit.TipoProduto}</td>
              <td className="border border-[#EDEBEB] px-4 py-2 text-left">{unit.Descricao}</td>
            </tr>
          ))}
        </tbody>
