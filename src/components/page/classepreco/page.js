...
const DataClassepreco = () => {
  ...
  const totalPages = Math.ceil(classeprecos.length / itemsPerPage);
  ...
  const columns = [
    ...
    { key: 'explorCenter', label: 'Exploration Center' },
  ];
  ...
  >
    ...
    <thead>
            <tr>
              ...
              <th className="uppercase border-collapse border border-[#EDEBEB] w-10 px-1 sm:px-5 py-4 bg-[#FC9D25] text-[#FAFAFA] text-sm">
                <div className="flex items-left justify-left">CodPrice</div>
              </th>
              )}
              {columnVisibility.abbreviation && (
              <th className="uppercase border-collapse border border-[#EDEBEB] w-120 px-1 sm:px-5 py-4 bg-[#FC9D25] text-[#FAFAFA] text-sm">
                <div className="flex items-left justify-left">Abbreviation</div>
              </th>
              )}
             {columnVisibility.description && (
              <th onClick={() => handleSort('Vdesc')} className="uppercase border-collapse border border-[#EDEBEB] w-120 sm:px-4 py-4 bg-[#FC9D25] text-[#FAFAFA] text-sm">
              ...
              {columnVisibility.explorCenter && (
              <th className="uppercase border-collapse border border-[#EDEBEB] w-50 px-1 sm:px-5 py-4 bg-[#FC9D25] text-[#FAFAFA] text-sm">
